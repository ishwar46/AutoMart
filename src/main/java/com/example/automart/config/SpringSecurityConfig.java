package  com.example.automart.config;
import com.example.automart.repository.UserRepository;
import com.example.automart.service.impl.UserDetailsServiceImpl;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                .antMatchers("/","/home","/index","/about","/help","/register","/list", "/cart/**").permitAll()
